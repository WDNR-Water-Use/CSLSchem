...
```{r psnt, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8.5, fig.height=5, fig.align="center"}
lake <- "Pleasant"
...
```{r long, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8.5, fig.height=5, fig.align="center"}
lake <- "Long"
plot_solutes(mass_fluxes, lake, text_size)
kableExtra::kable(format_table(mass_fluxes, lake), 
                  caption = sprintf("Percent of Total Inflow: %s Lake", lake))
...
```{r pfl, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8.5, fig.height=5, fig.align="center"}
lake <- "Plainfield"
plot_solutes(mass_fluxes, lake, text_size)
kableExtra::kable(format_table(mass_fluxes, lake), 
                  caption = sprintf("Percent of Total Inflow: %s Lake", lake))

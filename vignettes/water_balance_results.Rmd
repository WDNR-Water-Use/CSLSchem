...
```{r annual1, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8.5, fig.height=3, fig.align="center"}
...
```{r annual2, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8.5, fig.height=3, fig.align="center"}
...
Here's how the **methods compare to one another** (all flows in m^3^/month) at
...
table <- data.frame(Method = c("Seepage Meter (average)", "d18O-derived", "Mg-derived"),
                    Jun18 = c(194000, NA, NA),
                    Jun19 = c(NA, 326000, 151000),
                    Sep18 = c(2350000, 308000, 248000),
                    Sep19 = c(NA, 264000, -104000))
...
table <- data.frame(Method = c("Seepage Meter (average)", "d18O-derived", "Mg-derived"),
                    Jun18 = c(21600, NA, NA),
                    Jun19 = c(NA, 119000, 11000),
                    Sep18 = c(22400, 17800, 15000),
                    Sep19 = c(NA, 19000, -11000))
colnames(table) <- c("Method", "Jun '18", "Jun '19", "Sep '18", "Sep '19")
...
table <- data.frame(Method = c("Seepage Meter (average)", "d18O-derived", "Mg-derived"),
                    Jun18 = c(111400, NA, NA),
                    Jun19 = c(NA, 174000, 4700),
                    Sep18 = c(25000, 34000, 15000),
                    Sep19 = c(NA, 47000, -6800))
colnames(table) <- c("Method", "Jun '18", "Jun '19", "Sep '18", "Sep '19")
